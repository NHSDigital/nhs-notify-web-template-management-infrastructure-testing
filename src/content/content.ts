...
const personalisationComponent = {
  ...
  details: {
    ...
    list: [
      ...
      { id: 'pds-item-10', item: '((address_line_2))' },
      { id: 'pds-item-11', item: '((address_line_3))' },
      { id: 'pds-item-12', item: '((address_line_4))' },
      { id: 'pds-item-13', item: '((address_line_5))' },
      { id: 'pds-item-14', item: '((address_line_6))' },
      { id: 'pds-item-15', item: '((address_line_7))' },
    ],
  },
};
